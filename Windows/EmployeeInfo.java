...
public class EmployeeInfo extends javax.swing.JFrame {
    ...
    public EmployeeInfo(String Name, String Email, String Phone, String Gender, String Age, String DateJoined ,String Rating, String Status, String TaxiID ) {
        initComponents();
        setVisible(true);
        
        userInfo11.setuserinfo(Name, Email, Phone, Gender, Age, DateJoined, Rating, Status, TaxiID);
    }
